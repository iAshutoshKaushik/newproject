...
<input class="form-control" type="text" name="mobile" maxlength="10" required autocomplete="off" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" />
</div>

<div class="form-group">
<label>Password</label>
<input class="form-control" type="password" name="newpassword" required autocomplete="off" pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])\S{3,}" />
</div>
