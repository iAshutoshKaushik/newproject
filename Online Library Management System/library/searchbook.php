...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h2 class="header-line">Search Books</h2>
    </div>
     <div class="row">
...
{               ?>                                      
 ...
 <?php $cnt=$cnt+1;}} ?>                                      
                    ...
                    <!--End Advanced Tables -->
                                           ...
                                           <a href="contactus.php"> <center><button type="submit" name="submit" class="btn btn-info">Click Here to Request a book If Not Found !! </button></center></a>
